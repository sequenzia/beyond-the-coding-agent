# Slide 51: The roadmap

Beat 3.4 The roadmap. Section 3. Time 0:35. One static screen; no internal builds.
...
- Preserve narrative number 51, the shared header, and mini-map.
- Show all four roadmap rows on entry. Hold them through the handoff to slide 52. Use hard cuts.
- Use the existing roadmap rows, with visual values in design brief §36.
- Explanations stay spoken. The takeaway is spoken, not shown.

## Talk track

[0:00] **Choose one narrow task**, such as summarizing a document with citations.
...
[0:31] **Autonomy is earned by evals, one step at a time.**

[0:35] Advance to slide 52.

Cut first: the document-summary example and the sentence about an existing AI feature. Never cut the four-step sequence or the closing line.
...
- Rehearse the four-step explanation within 0:35.
