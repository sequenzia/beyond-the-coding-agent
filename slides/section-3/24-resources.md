...
Beat 3.5 Resources and close, first half. Section 3. Time 0:08 of the beat's 0:30; slide 25 takes 0:22. Builds: 0.
...
- Six lines, plain, readable from a phone camera. This slide exists to be photographed, so no builds, no images, and nothing below the fold.
- Group the three Anthropic posts on one line and the two Husain items on one line so the list stays at six entries.
