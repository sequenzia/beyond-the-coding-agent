...
Beat 3.5 Close and resources, first half. Section 3. Time 0:22 of the beat's 0:30; slide 53 takes 0:08. Builds: 1.
...
- Display narrative number 52 throughout, using the shared component in the design brief.
...
- "Questions" sits beneath the two sentences in the same type, smaller. No contact details, no handles, no logos; those belong on slide 2 or slide 53 if anywhere.
