...
- Display narrative number 49 throughout. Preserve the shared header and mini-map.
- One static, editable table. All six rows appear on entry and remain visible through the handoff to slide 50. Use hard cuts.
- Match slide 48's flat table treatment. Give the competency column more room for its descriptions, as defined in design brief §§25 and 36.
