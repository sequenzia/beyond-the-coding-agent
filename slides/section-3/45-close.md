...
Beat 3.5 Resources and close, second half. Section 3. Time 0:22 of the beat's 0:30; slide 44 took 0:08. Builds: 1. Stays up for the remaining questions and discussion time.
...
- Display narrative number 45 throughout, using the shared component in the design brief.
...
- "Questions" sits beneath the two sentences in the same type, smaller. No contact details, no handles, no logos; those belong on slide 2 or slide 44 if anywhere.
