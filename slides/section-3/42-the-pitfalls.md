# Slide 42: The pitfalls, on one slide
...
- The pitfall text after each colon matches the pitfall sentence on slides 11, 16, 21, 26, 31, and 36 exactly. If a sentence changes, update this recap with it.
...
[0:35] Advance to slide 43.

The track runs about 0:34. The five seconds of silence at the top are deliberate; the audience needs them to recognize the six lines. Cuttable if Section 3 runs long: the framework paragraph, which returns on slide 43 as "own the harness." Do not cut the two bold lines.
