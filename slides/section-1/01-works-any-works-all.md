# Slide 1: works.any() and works.all()

Beat 1.1 Opener. Section 1. Time 1:00. Builds: 1.

## On the slide

**Title state.** On screen as the room settles.

- Beyond the Coding Agent
- From Software Engineer to AI Engineer
- Stephen Sequenzia · Senior Staff AI/ML Engineer and Architect. Matches slide 2. No employer on the deck.
- [you write] Conference name and date, if the template calls for it

**Build 1.** The title leaves. Two lines fill the screen.
...
[0:00] Title state. A greeting, nothing more.

In June 2025, Andrej Karpathy put the whole problem in one line.
...
- Karpathy, "Software Is Changing (Again)," YC AI Startup School, June 17, 2025. Research §2 in `research/section-1.md`. Marked `[primary]`, quoted verbatim from the Latent Space transcript. No `[verify]` flag.

## Open items

- Conference name and date on the title state, if wanted.
