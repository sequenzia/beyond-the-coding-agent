# Slide 10: How we'll explore the six areas

Beat 2.0. Section 2. Rehearsal reference 0:45 of the beat's 1:50, paired with slide 9 at 1:05. Section 2 remains 25:00 to 29:00; these cues sum to a 28:30 rehearsal reference. One static screen; no internal builds.

## On the slide

**Kicker:** Section 2 · Orientation

**Title:** How we'll explore the six areas
...
- Existing Section 2 teaching pattern and illustrative FRB rationale. Research §0 in `research/section-2.md`.
- Illustrative purpose, request, and human authority boundary: `internal/frb-running-example.md`. All cases and outputs are invented; no deployment or measured results are claimed.
