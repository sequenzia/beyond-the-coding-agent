...
Beat 2.0. Section 2. Rehearsal reference 1:05 of beat 2.0's 1:50. Section 2 remains 25:00 to 29:00; these cues sum to a 28:30 rehearsal reference. Six map states; five hard-cut advances.
...
[0:46] **ACROSS-RUN SERVICES**

Observability, evaluations, and governance let the team learn from and control many runs.

[0:57] **FULL MAP**

You encounter these components in coding agents such as Codex CLI and Devin. **Everything around the model is engineering work.**

[1:05] Advance to slide 10.

Cut first: the layer inventory. Never cut the model-plus-harness definition or the engineering responsibility. The next slide introduces the illustrative FRB purpose and human decision boundary. Cue times are rehearsal guides, not automatic playback timing.
