# Slide 20: Evidence for the FRB brief
...
- Display narrative number 20, the area kicker, and `mini-context` throughout.
...
- The evidence statement describes the expected condition to check, not a measured passing result. The detailed answer-support check stays on slide 35.
