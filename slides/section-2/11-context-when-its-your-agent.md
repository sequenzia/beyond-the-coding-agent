...
**Build 1. The window.** A frame labeled "the window," holding six boxes in a row.

Instructions · Examples · Retrieved knowledge · Session state · Memory · Tool results

Beneath the frame, one line: Each has a relevance, a freshness, a provenance, and a size.

**Build 2. You now own.** Four items in a row.
...
What goes in the window: instructions, examples, retrieved knowledge, session state, memory, tool results. Each has a relevance, a freshness, a provenance, and a size.

[0:10] Build 2.

The vendor chose your context budget, your compaction policy, your memory convention, and your retrieval strategy. **You own all four now.**
...
The pitfall: **adding context instead of curating it.** A big window is not permission to fill it.

[0:41] **Context is a budget, not a bucket.**

[1:00] Advance to slide 12.

The track runs about 0:45. The slack is for the two customer-facing sentences, which should be delivered slowly. Nothing on this slide is cuttable; it is already the short form.

## Sources

- The six contents of the window, the four attributes, and the four things you own are the talk's own framing, drawn from Anthropic's context-engineering post and the Karpathy enumeration on slide 10. Research §2 in `research/section-2.md`.
- Chroma's finding, on slide 10, is the evidence behind "a big window is not permission to fill it." Research §2. `[primary]`.
- No new claims on this slide.
