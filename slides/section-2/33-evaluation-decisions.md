...
- Keep the code/model/expert comparison and fixture-specific outcome qualifications in the talk track, anchored to the matrix. The main source-support example remains on slide 35.
