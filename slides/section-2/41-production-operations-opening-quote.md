# Slide 41: AgentOps, opening quote

Beat 2.6. Section 2. Rehearsal reference 0:25 of the area's 4:10. Section 2 remains 25:00 to 29:00; these cues sum to a 28:55 rehearsal reference. One static screen; no internal builds.
...
- Display narrative number 41, the area kicker, and `mini-operating` throughout.
...
- Reuse `internal/illustrations/operating-observability.png`. Keep the exact quotation and attribution as native text; no separate title.
