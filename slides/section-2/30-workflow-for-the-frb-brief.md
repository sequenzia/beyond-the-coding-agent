# Slide 30: Recovery after an uncertain export
...
- Display narrative number 30, the area kicker, and `mini-orchestration` throughout.
...
- This is a separate permitted export of the checked draft, not a continuation that bypasses the rejected destination on slide 25.
...
- The six-stage workflow now appears on slide 27. Operation-reference mechanics and qualified idempotency stay in the talk track and shared reference.
