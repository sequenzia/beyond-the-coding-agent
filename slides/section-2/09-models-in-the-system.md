...
- Display narrative number 9, the area kicker, and `mini-models` throughout.
...
[0:45] Advance to slide 10.

Cut first: the task-example inventory. Never cut data eligibility and task fit. Cue times are rehearsal guides, not automatic playback timing.
