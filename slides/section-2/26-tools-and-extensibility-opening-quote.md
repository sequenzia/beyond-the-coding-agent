# Slide 26: Tools & Extensibility, opening quote

Beat 2.3. Section 2. Rehearsal reference 0:20 of the area's 4:10. Section 2 remains 25:00 to 29:00; these cues sum to a 28:55 rehearsal reference. One static screen; no internal builds.
...
Anthropic
Writing effective tools for agents, with agents, September 2025

## Layout and visual

- Display narrative number 26, the area kicker, and `mini-tools` throughout.
...
- Reuse `internal/illustrations/tools-interface.png`. Keep the exact quotation and attribution as native text; no separate title.
