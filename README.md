...
The [Section 2 content rework](outlines/section-2-rework/README.md) has been integrated into the current outline and slide specs. Its [section review](outlines/section-2-rework/section-review.md), [spoken pass](outlines/section-2-rework/spoken-pass.md), [slide map](outlines/section-2-rework/slide-map.md), and [numbering map](outlines/section-2-rework/numbering-map.json) remain supporting authoring records. Section 1 now runs title, bio, agenda, Section 1 divider, opening hook, thesis, comparison and production readiness, then the Section 2 divider. Section 2 opens with the map and a teaching-pattern and FRB orientation. Section 2 is slides 9 through 41; Section 3 is 42 through 48. The [Section 1 numbering map](internal/deck/section-1-numbering-map.json) records the preceding migration; the [orientation numbering map](internal/deck/section-2-orientation-numbering-map.json) records the new slide 10 and subsequent renumbering. Earlier review records retain their historical numbering. The reusable builder now implements the same numbered content and preserves its authored and expanded build maps. Render and native-playback review accompany each delivered build.
