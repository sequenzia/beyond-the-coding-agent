...
- **Deck:** 51 narrative slides across sections of 8, 33, and 10 slides, including three untimed resource pages. The 51 authored compositions expand to 56 physical slides and 57 presentation states, with one internal click and no Morph transitions.
...
- `research/external/ai-engineering-top-training-resources.md` is the detailed learning guide behind Resources on slides 48 through 51. Section 3 research §6 holds the verified slide evidence.
